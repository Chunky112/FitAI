        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-display font-bold text-white">FitAI</span>
            </Link>
            <p className="mt-4 text-gray-400">
              AI-powered fitness platform providing personalized workout and nutrition plans to help you achieve your fitness goals.
            </p>
          </div>
